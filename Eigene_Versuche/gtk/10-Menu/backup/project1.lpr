...
var
  ...
  (path: '/Datei/Öffnen'; accelerator: '<control>b'; callback: nil; callback_action: 0; item_type: '<Branch>'; extra_data: nil),
  (path: '/Datei/Beenden'; accelerator: '<control>q'; callback: @gtk_main_quit; callback_action: 0; item_type: '<Branch>'; extra_data: nil));
