...
{$include <gdk/gdkversionmacros.h>}
  ...
  type
    GtkCssParserError = (GTK_CSS_PARSER_ERROR_FAILED,GTK_CSS_PARSER_ERROR_SYNTAX,
   ...
   * skip any input, but they indicate issues that should be fixed.
    ...
    GtkCssParserWarning = (GTK_CSS_PARSER_WARNING_DEPRECATED,GTK_CSS_PARSER_WARNING_SYNTAX,
