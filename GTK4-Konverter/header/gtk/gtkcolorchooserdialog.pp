...
{$include <gtk/gtkdialog.h>}
  ...
  type
    _GtkColorChooserDialog = GtkColorChooserDialog;
  { Zeile entfernt  }

  function gtk_color_chooser_dialog_get_type:GType;

  { Zeile entfernt  }
(* Const before type ignored *)
  function gtk_color_chooser_dialog_new(title:Pchar; parent:PGtkWindow):^GtkWidget;

  { Zeile entfernt  }
{$endif}
  { __GTK_COLOR_CHOOSER_DIALOG_H__  }
  { was #define dname def_expr }
  function GTK_TYPE_COLOR_CHOOSER_DIALOG : longint; { return type might be wrong }
    begin
  ...
  function gtk_color_chooser_dialog_new(title:Pchar; parent:PGtkWindow):PGtkWidget;
  begin
    { You must implement this function }
  end;
