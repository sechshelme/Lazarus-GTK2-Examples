...
{$include <gtk/gtkbuilder.h>}
  ...
  type
    _GtkBuildable = GtkBuildable;
  { Dummy typedef  }
    _GtkBuildableIface = GtkBuildableIface;
    _GtkBuildableParseContext = GtkBuildableParseContext;
    _GtkBuildableParser = GtkBuildableParser;
  {*
...
(* Const before type ignored *)
  ...
  {< private > }
    _GtkBuildableParser = record
        start_element : procedure (context:PGtkBuildableParseContext; element_name:Pchar; attribute_names:PPchar; attribute_values:PPchar; user_data:gpointer; 
                      error:PPGError);cdecl;
        end_element : procedure (context:PGtkBuildableParseContext; element_name:Pchar; user_data:gpointer; error:PPGError);cdecl;
        text : procedure (context:PGtkBuildableParseContext; text:Pchar; text_len:gsize; user_data:gpointer; error:PPGError);cdecl;
...
(* Const before type ignored *)
    _GtkBuildableIface = record
        ...
        custom_tag_end : procedure (buildable:PGtkBuildable; builder:PGtkBuilder; child:PGObject; tagname:Pchar; data:gpointer);cdecl;
        custom_finished : procedure (buildable:PGtkBuildable; builder:PGtkBuilder; child:PGObject; tagname:Pchar; data:gpointer);cdecl;
...
{$endif}
  ...
  function gtk_buildable_parse_context_get_element(context:PGtkBuildableParseContext):Pchar;
  begin
    { You must implement this function }
  end;
  function gtk_buildable_parse_context_get_element_stack(context:PGtkBuildableParseContext):PGPtrArray;
  begin
    { You must implement this function }
  end;
  procedure gtk_buildable_parse_context_get_position(context:PGtkBuildableParseContext; line_number:Plongint; char_number:Plongint);
