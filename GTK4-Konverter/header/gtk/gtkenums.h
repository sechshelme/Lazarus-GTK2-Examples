...
/**
 * GtkAccessibleRole:
 * @_ROLE_ALERT: An element with important, and usually
 *   time-sensitive, information
 * @_ROLE_ALERT_DIALOG: A type of dialog that contains an
 *   alert message
 * @_ROLE_BANNER: Unused
 * @_ROLE_BUTTON: An input element that allows for
 *   user-triggered actions when clicked or pressed
 * @_ROLE_CAPTION: Unused
 * @_ROLE_CELL: Unused
 * @_ROLE_CHECKBOX: A checkable input element that has
 *   three possible values: `true`, `false`, or `mixed`
 * @_ROLE_COLUMN_HEADER: A header in a columned list.
 * @_ROLE_COMBO_BOX: An input that controls another element,
 *   such as a list or a grid, that can dynamically pop up to help the user
 *   set the value of the input
 * @_ROLE_COMMAND: Abstract role.
 * @_ROLE_COMPOSITE: Abstract role.
 * @_ROLE_DIALOG: A dialog is a window that is designed to interrupt
 *    the current processing of an application in order to prompt the user to enter
 *    information or require a response.
 * @_ROLE_DOCUMENT: Unused
 * @_ROLE_FEED: Unused
 * @_ROLE_FORM: Unused
 * @_ROLE_GENERIC: Unused
 * @_ROLE_GRID: A grid of items.
 * @_ROLE_GRID_CELL: An item in a grid or tree grid.
 * @_ROLE_GROUP: An element that groups multiple widgets. GTK uses
 *   this role for various containers, like [class@Box], [class@Viewport], and [class@HeaderBar].
 * @_ROLE_HEADING: Unused
 * @_ROLE_IMG: An image.
 * @_ROLE_INPUT: Abstract role.
 * @_ROLE_LABEL: A visible name or caption for a user interface component.
 * @_ROLE_LANDMARK: Abstract role.
 * @_ROLE_LEGEND: Unused
 * @_ROLE_LINK: A clickable link.
 * @_ROLE_LIST: A list of items.
 * @_ROLE_LIST_BOX: Unused.
 * @_ROLE_LIST_ITEM: An item in a list.
 * @_ROLE_LOG: Unused
 * @_ROLE_MAIN: Unused
 * @_ROLE_MARQUEE: Unused
 * @_ROLE_MATH: Unused
 * @_ROLE_METER: An element that represents a value within a known range.
 * @_ROLE_MENU: A menu.
 * @_ROLE_MENU_BAR: A menubar.
 * @_ROLE_MENU_ITEM: An item in a menu.
 * @_ROLE_MENU_ITEM_CHECKBOX: A check item in a menu.
 * @_ROLE_MENU_ITEM_RADIO: A radio item in a menu.
 * @_ROLE_NAVIGATION: Unused
 * @_ROLE_NONE: An element that is not represented to accessibility technologies.
 * @_ROLE_NOTE: Unused
 * @_ROLE_OPTION: Unused
 * @_ROLE_PRESENTATION: An element that is not represented to accessibility technologies.
 * @_ROLE_PROGRESS_BAR: An element that displays the progress
 *    status for tasks that take a long time.
 * @_ROLE_RADIO: A checkable input in a group of radio roles,
 *    only one of which can be checked at a time.
 * @_ROLE_RADIO_GROUP: Unused
 * @_ROLE_RANGE: Abstract role.
 * @_ROLE_REGION: Unused
 * @_ROLE_ROW: A row in a columned list.
 * @_ROLE_ROW_GROUP: Unused
 * @_ROLE_ROW_HEADER: Unused
 * @_ROLE_SCROLLBAR: A graphical object that controls the scrolling
 *    of content within a viewing area, regardless of whether the content is fully
 *    displayed within the viewing area.
 * @_ROLE_SEARCH: Unused
 * @_ROLE_SEARCH_BOX: A type of textbox intended for specifying
 *    search criteria.
 * @_ROLE_SECTION: Abstract role.
 * @_ROLE_SECTION_HEAD: Abstract role.
 * @_ROLE_SELECT: Abstract role.
 * @_ROLE_SEPARATOR: A divider that separates and distinguishes
 *    sections of content or groups of menuitems.
 * @_ROLE_SLIDER: A user input where the user selects a value
 *    from within a given range.
 * @_ROLE_SPIN_BUTTON: A form of range that expects the user to
 *    select from among discrete choices.
 * @_ROLE_STATUS: Unused
 * @_ROLE_STRUCTURE: Abstract role.
 * @_ROLE_SWITCH: A type of checkbox that represents on/off values,
 *    as opposed to checked/unchecked values.
 * @_ROLE_TAB: An item in a list of tab used for switching pages.
 * @_ROLE_TABLE: Unused
 * @_ROLE_TAB_LIST: A list of tabs for switching pages.
 * @_ROLE_TAB_PANEL: A page in a notebook or stack.
 * @_ROLE_TEXT_BOX: A type of input that allows free-form text
 *    as its value.
 * @_ROLE_TIME: Unused
 * @_ROLE_TIMER: Unused
 * @_ROLE_TOOLBAR: Unused
 * @_ROLE_TOOLTIP: Unused
 * @_ROLE_TREE: Unused
 * @_ROLE_TREE_GRID: A treeview-like, columned list.
 * @_ROLE_TREE_ITEM: Unused
 * @_ROLE_WIDGET: An interactive component of a graphical user
 *    interface. This is the role that GTK uses by default for widgets.
 * @_ROLE_WINDOW: An application window.
 *
...
typedef enum {
  ...
  _ROLE_MENU_BAR,
  _ROLE_MENU_ITEM,
  _ROLE_MENU_ITEM_CHECKBOX,
  _ROLE_MENU_ITEM_RADIO,
  _ROLE_NAVIGATION,
  _ROLE_NONE,
  _ROLE_NOTE,
  _ROLE_OPTION,
...
/**
 * GtkAccessibleState:
 * @_STATE_BUSY: A “busy” state. This state has boolean values
 * @_STATE_CHECKED: A “checked” state; indicates the current
 *   state of a [class@CheckButton]. Value type: [enum@AccessibleTristate]
 * @_STATE_DISABLED: A “disabled” state; corresponds to the
 *   [property@Widget:sensitive] property. It indicates a UI element
 *   that is perceivable, but not editable or operable. Value type: boolean
 * @_STATE_EXPANDED: An “expanded” state; corresponds to the
 *   [property@Expander:expanded] property. Value type: boolean
 *   or undefined
 * @_STATE_HIDDEN: A “hidden” state; corresponds to the
 *   [property@Widget:visible] property. You can use this state
 *   explicitly on UI elements that should not be exposed to an assistive
 *   technology. Value type: boolean
 *   See also: %_STATE_DISABLED
 * @_STATE_INVALID: An “invalid” state; set when a widget
 *   is showing an error. Value type: [enum@AccessibleInvalidState]
 * @_STATE_PRESSED: A “pressed” state; indicates the current
 *   state of a [class@ToggleButton]. Value type: [enum@AccessibleTristate]
 *   enumeration
 * @_STATE_SELECTED: A “selected” state; set when a widget
 ...
 * value is undefined.
 */
#define _VALUE_UNDEFINED  (-1)

/**
 * GtkAccessibleProperty:
 * @_PROPERTY_AUTOCOMPLETE: Indicates whether inputting text
 *    could trigger display of one or more predictions of the user's intended
 *    value for a combobox, searchbox, or textbox and specifies how predictions
 *    would be presented if they were made. Value type: [enum@AccessibleAutocomplete]
 * @_PROPERTY_DESCRIPTION: Defines a string value that describes
 *    or annotates the current element. Value type: string
 * @_PROPERTY_HAS_POPUP: Indicates the availability and type of
 *    interactive popup element, such as menu or dialog, that can be triggered
 *    by an element.
 * @_PROPERTY_KEY_SHORTCUTS: Indicates keyboard shortcuts that an
 *    author has implemented to activate or give focus to an element. Value type:
 *    string
 * @_PROPERTY_LABEL: Defines a string value that labels the current
 *    element. Value type: string
 * @_PROPERTY_LEVEL: Defines the hierarchical level of an element
 *    within a structure. Value type: integer
 * @_PROPERTY_MODAL: Indicates whether an element is modal when
 *    displayed. Value type: boolean
 * @_PROPERTY_MULTI_LINE: Indicates whether a text box accepts
 *    multiple lines of input or only a single line. Value type: boolean
 * @_PROPERTY_MULTI_SELECTABLE: Indicates that the user may select
 *    more than one item from the current selectable descendants. Value type:
 *    boolean
 * @_PROPERTY_ORIENTATION: Indicates whether the element's
 *    orientation is horizontal, vertical, or unknown/ambiguous. Value type:
 *    [enum@Orientation]
 * @_PROPERTY_PLACEHOLDER: Defines a short hint (a word or short
 *    phrase) intended to aid the user with data entry when the control has no
 *    value. A hint could be a sample value or a brief description of the expected
 *    format. Value type: string
 * @_PROPERTY_READ_ONLY: Indicates that the element is not editable,
 *    but is otherwise operable. Value type: boolean
 * @_PROPERTY_REQUIRED: Indicates that user input is required on
 *    the element before a form may be submitted. Value type: boolean
 * @_PROPERTY_ROLE_DESCRIPTION: Defines a human-readable,
 *    author-localized description for the role of an element. Value type: string
 * @_PROPERTY_SORT: Indicates if items in a table or grid are
 *    sorted in ascending or descending order. Value type: [enum@AccessibleSort]
 * @_PROPERTY_VALUE_MAX: Defines the maximum allowed value for a
 *    range widget. Value type: double
 * @_PROPERTY_VALUE_MIN: Defines the minimum allowed value for a
 *    range widget. Value type: double
 * @_PROPERTY_VALUE_NOW: Defines the current value for a range widget.
 *    Value type: double
 * @_PROPERTY_VALUE_TEXT: Defines the human readable text alternative
 *    of aria-valuenow for a range widget. Value type: string
 *
 * The possible accessible properties of a [iface@Accessible].
 */
typedef enum {
  _PROPERTY_AUTOCOMPLETE,
  _PROPERTY_DESCRIPTION,
  _PROPERTY_HAS_POPUP,
  _PROPERTY_KEY_SHORTCUTS,
  _PROPERTY_LABEL,
  _PROPERTY_LEVEL,
  _PROPERTY_MODAL,
  _PROPERTY_MULTI_LINE,
  _PROPERTY_MULTI_SELECTABLE,
  _PROPERTY_ORIENTATION,
  _PROPERTY_PLACEHOLDER,
  _PROPERTY_READ_ONLY,
  _PROPERTY_REQUIRED,
  _PROPERTY_ROLE_DESCRIPTION,
  _PROPERTY_SORT,
  _PROPERTY_VALUE_MAX,
  _PROPERTY_VALUE_MIN,
  _PROPERTY_VALUE_NOW,
  _PROPERTY_VALUE_TEXT
} GtkAccessibleProperty;

/**
 * GtkAccessibleRelation:
 * @_RELATION_ACTIVE_DESCENDANT: Identifies the currently active
 *    element when focus is on a composite widget, combobox, textbox, group,
 *    or application. Value type: reference
 * @_RELATION_COL_COUNT: Defines the total number of columns
 *    in a table, grid, or treegrid. Value type: integer
 * @_RELATION_COL_INDEX: Defines an element's column index or
 *    position with respect to the total number of columns within a table,
 *    grid, or treegrid. Value type: integer
 * @_RELATION_COL_INDEX_TEXT: Defines a human readable text
 *   alternative of %_RELATION_COL_INDEX. Value type: string
 * @_RELATION_COL_SPAN: Defines the number of columns spanned
 *   by a cell or gridcell within a table, grid, or treegrid. Value type: integer
 * @_RELATION_CONTROLS: Identifies the element (or elements) whose
 *    contents or presence are controlled by the current element. Value type: reference
 * @_RELATION_DESCRIBED_BY: Identifies the element (or elements)
 *    that describes the object. Value type: reference
 * @_RELATION_DETAILS: Identifies the element (or elements) that
 *    provide additional information related to the object. Value type: reference
 * @_RELATION_ERROR_MESSAGE: Identifies the element that provides
 *    an error message for an object. Value type: reference
 * @_RELATION_FLOW_TO: Identifies the next element (or elements)
 *    in an alternate reading order of content which, at the user's discretion,
 *    allows assistive technology to override the general default of reading in
 *    document source order. Value type: reference
 * @_RELATION_LABELLED_BY: Identifies the element (or elements)
 *    that labels the current element. Value type: reference
 * @_RELATION_OWNS: Identifies an element (or elements) in order
 *    to define a visual, functional, or contextual parent/child relationship
 *    between elements where the widget hierarchy cannot be used to represent
 *    the relationship. Value type: reference
 * @_RELATION_POS_IN_SET: Defines an element's number or position
 *    in the current set of listitems or treeitems. Value type: integer
 * @_RELATION_ROW_COUNT: Defines the total number of rows in a table,
 *    grid, or treegrid. Value type: integer
 * @_RELATION_ROW_INDEX: Defines an element's row index or position
 *    with respect to the total number of rows within a table, grid, or treegrid.
 *    Value type: integer
 * @_RELATION_ROW_INDEX_TEXT: Defines a human readable text
 *    alternative of aria-rowindex. Value type: string
 * @_RELATION_ROW_SPAN: Defines the number of rows spanned by a
 *    cell or gridcell within a table, grid, or treegrid. Value type: integer
 * @_RELATION_SET_SIZE: Defines the number of items in the current
 ...
 */
typedef enum {
  _RELATION_ACTIVE_DESCENDANT,
  _RELATION_COL_COUNT,
  _RELATION_COL_INDEX,
  _RELATION_COL_INDEX_TEXT,
  _RELATION_COL_SPAN,
  _RELATION_CONTROLS,
  _RELATION_DESCRIBED_BY,
  _RELATION_DETAILS,
  _RELATION_ERROR_MESSAGE,
  _RELATION_FLOW_TO,
  _RELATION_LABELLED_BY,
  _RELATION_OWNS,
  _RELATION_POS_IN_SET,
  _RELATION_ROW_COUNT,
  _RELATION_ROW_INDEX,
  _RELATION_ROW_INDEX_TEXT,
  _RELATION_ROW_SPAN,
  _RELATION_SET_SIZE
} GtkAccessibleRelation;
 ...
 * @_TRISTATE_FALSE: The state is `false`
 * @_TRISTATE_TRUE: The state is `true`
 * @_TRISTATE_MIXED: The state is `mixed`
 *
 * The possible values for the %_STATE_PRESSED
 * accessible state.
 *
 * Note that the %_TRISTATE_FALSE and
 * %_TRISTATE_TRUE have the same values
 * as %FALSE and %TRUE.
 */
typedef enum {
  _TRISTATE_FALSE,
 ...
 * @_INVALID_FALSE: There are no detected errors in the value
 * @_INVALID_TRUE: The value entered by the user has failed validation
 * @_INVALID_GRAMMAR: A grammatical error was detected
 * @_INVALID_SPELLING: A spelling error was detected
 *
 * The possible values for the %_STATE_INVALID
 * accessible state.
 *
 * Note that the %_INVALID_FALSE and
 * %_INVALID_TRUE have the same values
 * as %FALSE and %TRUE.
 */
typedef enum { /*< prefix=_INVALID >*/
  _INVALID_FALSE,
  _INVALID_TRUE,
  _INVALID_GRAMMAR,
  _INVALID_SPELLING,
 ...
 * @_AUTOCOMPLETE_NONE: Automatic suggestions are not displayed.
 * @_AUTOCOMPLETE_INLINE: When a user is providing input, text
 *    suggesting one way to complete the provided input may be dynamically
 *    inserted after the caret.
 * @_AUTOCOMPLETE_LIST: When a user is providing input, an element
 *    containing a collection of values that could complete the provided input
 *    may be displayed.
 * @_AUTOCOMPLETE_BOTH: When a user is providing input, an element
 *    containing a collection of values that could complete the provided input
 *    may be displayed. If displayed, one value in the collection is automatically
 *    selected, and the text needed to complete the automatically selected value
 *    appears after the caret in the input.
 *
 * The possible values for the %_PROPERTY_AUTOCOMPLETE
 * accessible property.
 */
typedef enum { /*< prefix=_AUTOCOMPLETE >*/
  _AUTOCOMPLETE_NONE,
  _AUTOCOMPLETE_INLINE,
  _AUTOCOMPLETE_LIST,
  _AUTOCOMPLETE_BOTH
} GtkAccessibleAutocomplete;
...
/**
 * GtkAccessibleSort:
 * @_SORT_NONE: There is no defined sort applied to the column.
 * @_SORT_ASCENDING: Items are sorted in ascending order by this column.
 * @_SORT_DESCENDING: Items are sorted in descending order by this column.
 * @_SORT_OTHER: A sort algorithm other than ascending or
 *    descending has been applied.
 *
 * The possible values for the %_PROPERTY_SORT
 * accessible property.
 */
typedef enum { /*< prefix=_SORT >*/
  _SORT_NONE,
  _SORT_ASCENDING,
  _SORT_DESCENDING,
  _SORT_OTHER
