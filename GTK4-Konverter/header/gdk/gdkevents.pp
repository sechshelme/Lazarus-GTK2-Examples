...
{$include <gdk/gdkversionmacros.h>}
  ...
  type
    _GdkEventSequence = GdkEventSequence;
    _GdkEvent = GdkEvent;
  ...
  type
    _GdkButtonEvent = GdkButtonEvent;
    _GdkCrossingEvent = GdkCrossingEvent;
    _GdkDeleteEvent = GdkDeleteEvent;
    _GdkDNDEvent = GdkDNDEvent;
    _GdkFocusEvent = GdkFocusEvent;
    _GdkGrabBrokenEvent = GdkGrabBrokenEvent;
    _GdkKeyEvent = GdkKeyEvent;
    _GdkMotionEvent = GdkMotionEvent;
    _GdkPadEvent = GdkPadEvent;
    _GdkProximityEvent = GdkProximityEvent;
    _GdkScrollEvent = GdkScrollEvent;
    _GdkTouchEvent = GdkTouchEvent;
    _GdkTouchpadEvent = GdkTouchpadEvent;
  {*
   * GdkEventType:
  ...
  { helper variable for decls  }
    ...
    GdkEventType = (GDK_DELETE,GDK_MOTION_NOTIFY,GDK_BUTTON_PRESS,
      ...
      GDK_PAD_BUTTON_PRESS,GDK_PAD_BUTTON_RELEASE,
      GDK_PAD_RING,GDK_PAD_STRIP,GDK_PAD_GROUP_MODE,
   ...
   * progress of the gesture.
    ...
    GdkTouchpadGesturePhase = (GDK_TOUCHPAD_GESTURE_PHASE_BEGIN,GDK_TOUCHPAD_GESTURE_PHASE_UPDATE,
   ...
   * Specifies the direction for scroll events.
    ...
    GdkScrollDirection = (GDK_SCROLL_UP,GDK_SCROLL_DOWN,GDK_SCROLL_LEFT,
   ...
   * Since: 4.8
    ...
    GdkScrollUnit = (GDK_SCROLL_UNIT_WHEEL,GDK_SCROLL_UNIT_SURFACE
      );
  {*
   * GdkNotifyType:
   ...
   * full details of crossing event generation.
    ...
    GdkNotifyType = (GDK_NOTIFY_ANCESTOR := 0,GDK_NOTIFY_VIRTUAL := 1,
   ...
   * Specifies the crossing mode for enter and leave events.
    ...
    GdkCrossingMode = (GDK_CROSSING_NORMAL,GDK_CROSSING_GRAB,
...
{$endif}
  ...
  function gdk_event_get_surface(event:PGdkEvent):PGdkSurface;
  begin
    { You must implement this function }
  end;
  function gdk_event_get_seat(event:PGdkEvent):PGdkSeat;
  begin
    { You must implement this function }
  end;
  function gdk_event_get_device(event:PGdkEvent):PGdkDevice;
  begin
    { You must implement this function }
  end;
  function gdk_event_get_device_tool(event:PGdkEvent):PGdkDeviceTool;
  begin
    { You must implement this function }
  end;
  function gdk_event_get_time(event:PGdkEvent):guint32;
  ...
  function gdk_event_get_display(event:PGdkEvent):PGdkDisplay;
  begin
    { You must implement this function }
  end;
  function gdk_event_get_event_sequence(event:PGdkEvent):PGdkEventSequence;
  begin
    { You must implement this function }
  end;
  function gdk_event_get_modifier_state(event:PGdkEvent):GdkModifierType;
  ...
  function gdk_event_get_history(event:PGdkEvent; out_n_coords:Pguint):PGdkTimeCoord;
  begin
    { You must implement this function }
  end;
  function gdk_event_get_pointer_emulated(event:PGdkEvent):gboolean;
  ...
  function gdk_grab_broken_event_get_grab_surface(event:PGdkEvent):PGdkSurface;
  begin
    { You must implement this function }
  end;
  function gdk_grab_broken_event_get_implicit(event:PGdkEvent):gboolean;
