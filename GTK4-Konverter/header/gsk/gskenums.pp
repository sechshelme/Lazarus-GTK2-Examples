...
{$endif}
  ...
  type
    GskRenderNodeType = (GSK_NOT_A_RENDER_NODE := 0,GSK_CONTAINER_NODE,
   ...
   * rendering pipeline.
    ...
    GskScalingFilter = (GSK_SCALING_FILTER_LINEAR,GSK_SCALING_FILTER_NEAREST,
   ...
   * on blending and blend modes.
    ...
    GskBlendMode = (GSK_BLEND_MODE_DEFAULT := 0,GSK_BLEND_MODE_MULTIPLY,
   ...
   * The corner indices used by `GskRoundedRect`.
    ...
    GskCorner = (GSK_CORNER_TOP_LEFT,GSK_CORNER_TOP_RIGHT,
   ...
   * multiplication `C = A * B`, `category(C) = MIN (category(A), category(B))`.
    ...
    GskTransformCategory = (GSK_TRANSFORM_CATEGORY_UNKNOWN,GSK_TRANSFORM_CATEGORY_ANY,
   ...
   * code, and what the corresponding C type is on the Gtk side.
    ...
    GskGLUniformType = (GSK_GL_UNIFORM_TYPE_NONE,GSK_GL_UNIFORM_TYPE_FLOAT,
